...
class _FakeChatwootClientService_0 extends _i1.SmartFake
  ...
  _FakeChatwootClientService_0(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeLocalStorage_1 extends _i1.SmartFake implements _i3.LocalStorage {
  _FakeLocalStorage_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeChatwootCallbacks_2 extends _i1.SmartFake
    implements _i4.ChatwootCallbacks {
  _FakeChatwootCallbacks_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockChatwootRepository extends _i1.Mock
  ...
  set callbacks(_i4.ChatwootCallbacks? value) => super.noSuchMethod(
    Invocation.setter(#callbacks, value),
  ...
  _i6.Future<void> initialize(_i7.ChatwootUser? user) =>
      (super.noSuchMethod(
            Invocation.method(#initialize, [user]),
  ...
  void getPersistedMessages() => super.noSuchMethod(
    Invocation.method(#getPersistedMessages, []),
    returnValueForMissingStub: null,
  );
  ...
  void listenForEvents() => super.noSuchMethod(
    Invocation.method(#listenForEvents, []),
    returnValueForMissingStub: null,
  );
  ...
  void sendAction(_i9.ChatwootActionType? action) => super.noSuchMethod(
    Invocation.method(#sendAction, [action]),
    returnValueForMissingStub: null,
  );
